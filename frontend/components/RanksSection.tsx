    ...
    <section id="ranks" className="px-6 md:px-15 py-16 md:py-25" ref={ref}>
      <div className="max-w-300 mx-auto">
        ...
        >
          ...
          >
            Based on your rolling 7-day average of deep work hours. No shame at
            any level — just honest classification. Identity-based dopamine
            beats point-based dopamine.
          </motion.p>
        </motion.div>
        ...
        >
          {RANKS.map((rank) => (
            ...
            >
              ...
              />
              <span className="block text-xl mb-3.5 opacity-65">
                {rank.icon}
              </span>
