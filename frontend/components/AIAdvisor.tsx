        ...
        >
          ...
          >
            <div className="self-end max-w-[85%]">
              <div className="text-[9px] tracking-widest uppercase text-text-secondary mb-1.5 text-right">
                You
              </div>
              <div
            ...
            <div className="max-w-[85%]">
              <div className="text-[9px] tracking-widest uppercase text-text-secondary mb-1.5">
                Advisor
              </div>
              <div className="text-[12px] text-text-primary leading-[1.75] tracking-[0.01em]">
                Revenue allocation is at 12% this week. Your declared priority
                is SaaS.
                <br />
                <br />
                School is at 44%. That&apos;s appropriate given the exam on Mar
                28.
                <br />
                <br />
                After the exam: shift revenue allocation to at least 30% before
                expanding scope on infra.
              </div>
            </div>
            ...
            <div className="max-w-[85%]">
              <div className="text-[12px] text-text-primary leading-[1.75] tracking-[0.01em]">
                ...
                <br />
                <br />
                No paying users yet. Sentry solves a production-scale problem
                you don&apos;t have.
                <br />
                <br />
